...
export const MobileBudget = (props: any) => {
    ...
    return (
        <div className="flex flex-col h-full overflow-hidden p-6 overflow-y-auto custom-scrollbar w-full">
            ...
            <div className="flex flex-col gap-4 mb-8 items-start bg-[rgba(0,0,0,0.3)] p-4 rounded border border-[rgba(255,255,255,0.05)] shadow-inner w-full">
                <div className="flex flex-col gap-1 w-full">
                    ...
                    <input 
                        type="range" 
                        className="w-full mt-3 accent-[#d2501a] cursor-pointer" 
                ...
                <div className="flex flex-col gap-2 w-full overflow-hidden mt-2">
                    <div className="flex gap-2 overflow-x-auto hide-scrollbar pb-1 snap-x pt-2">
            ...
            <div className="bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.05)] rounded p-4 mb-8 w-full">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <div className="flex flex-col items-center justify-center bg-[rgba(0,0,0,0.4)] px-6 py-4 rounded border border-[rgba(255,255,255,0.05)] mt-2">
